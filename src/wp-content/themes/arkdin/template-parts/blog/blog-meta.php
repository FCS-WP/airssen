...
$arkdin_blog_date = get_theme_mod( 'arkdin_blog_date', true );
$arkdin_blog_comments = get_theme_mod( 'arkdin_blog_comments', true );
$arkdin_blog_author = get_theme_mod( 'arkdin_blog_author', true );
$arkdin_blog_cat = get_theme_mod( 'arkdin_blog_cat', false );
...
<div class="blog-post-meta">
    <ul class="list-wrap">
        ...
        <?php if ( !empty($arkdin_blog_author) ): ?>
        ...
        <?php if ( !empty($arkdin_blog_comments) ): ?>
