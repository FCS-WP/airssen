...
function tp_get_allowed_html_desc($level = 'basic')
{
    ...
    return sprintf(__('This input field has support for the following HTML tags: %1$s', 'tscore'), '<code>' . esc_html($tags_str) . '</code>');
}
