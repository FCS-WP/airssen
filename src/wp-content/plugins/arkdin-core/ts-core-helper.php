<?php
/**
	* Plugin Name: Arkdin Core
	* Description: Arkdin elementor core plugin.
	* Plugin URI:  https://themeforest.net/user/laralink/
	* Version:     1.0
...
include_once(TSCORE_ADDONS_DIR . '/include/custom-post-project.php');
...
include_once(TSCORE_WIDGET_PATH . '/ts-contact-info-widget.php');
include_once(TSCORE_WIDGET_PATH . '/ts-contact-info-widget2.php');
include_once(TSCORE_WIDGET_PATH . '/ts-subscriber-widget.php');


if ( class_exists('Charitable_Campaign' ) ) {
	include_once(TSCORE_WIDGET_PATH . '/tp-donation-post.php');
}
// include_once(TSCORE_WIDGET_PATH . '/tp-latest-posts-footer.php');
...
final class TP_Core {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Arkdin Core', 'tscore' ) . '</strong>',
